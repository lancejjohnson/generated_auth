defmodule GeneratedAuth.AccountsTest do
  use GeneratedAuth.DataCase

  alias GeneratedAuth.Accounts
  import GeneratedAuth.AccountsFixtures
  alias GeneratedAuth.Accounts.{Account, AccountToken}
  ...
  describe "register_account/1" do
    ...
    test "registers accounts with a hashed password" do
      ...
      {:ok, account} = Accounts.register_account(%{email: email, password: valid_account_password()})
  ...
  describe "change_account_registration/2" do
    ...
    test "allows fields to be set" do
      ...
      changeset =
        Accounts.change_account_registration(%Account{}, %{"email" => email, "password" => password})
