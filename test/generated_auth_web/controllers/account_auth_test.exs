defmodule GeneratedAuthWeb.AccountAuthTest do
  ...
  @remember_me_cookie "_generated_auth_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GeneratedAuthWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GeneratedAuthWeb.Endpoint.subscribe(live_socket_id)
      ...
      assert_receive %Phoenix.Socket.Broadcast{
        event: "disconnect",
        topic: "accounts_sessions:abcdef-token"
      }
    end
