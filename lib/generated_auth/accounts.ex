defmodule GeneratedAuth.Accounts do
  @moduledoc """
  ...
  alias GeneratedAuth.Accounts.{Account, AccountToken, AccountNotifier}
  ...
  defp account_email_multi(account, email, context) do
    changeset = account |> Account.email_changeset(%{email: email}) |> Account.confirm_changeset()
  ...
  ## Examples
      ...
      iex> deliver_account_confirmation_instructions(account, &Routes.account_confirmation_url(conn, :confirm, &1))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_account_confirmation_instructions(confirmed_account, &Routes.account_confirmation_url(conn, :confirm, &1))
