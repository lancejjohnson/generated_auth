defmodule GeneratedAuth.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, GeneratedAuth.Repo)
  ...
  """
  def valid_password?(%GeneratedAuth.Accounts.Account{hashed_password: hashed_password}, password)
